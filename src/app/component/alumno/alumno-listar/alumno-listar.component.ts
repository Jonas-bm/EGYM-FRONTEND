...
export class AlumnoListarComponent implements OnInit {
  ...
  idMayor: number = 0
  displayedColumns:String[]=['codigo','nombre','apellidoPaterno','apellidoMaterno','dni','direccion','celular','fechaNacimiento','peso','talla','acciones1','acciones2'] //agregamos el componente (mediante consola)
